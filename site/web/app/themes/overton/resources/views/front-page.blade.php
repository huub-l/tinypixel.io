  ...
  @while(have_posts()) @php the_post() @endphp
    <header class="max-w-full overflow-hidden bg-indigo">
      <div class="flex flex-grow sm:flex-row-reverse flex-wrap max-w-lg w-full 
        ...
        <div class="inline-block w-full max-w-lg md:w-1/2 mx-auto bg-left-bottom bg-no-repeat bg-contain text-white mb-12 md:mb-0 items-center md:items-start" style="background:url('@asset('svg/squares.svg')');">
            ...
            <p class="md:max-w-md  mb-8 text-center md:text-left">Tiny Pixel partners with progressive non-profits to create meaningful digital experiences that 
              inspire change.</p>
            <p class="md:text-left self-center items-center text-center"><a class="mx-0 text-white border-white border rounded 
    ...
    <header class="flex flex-grow flex-wrap w-full overflow-hidden 
      ...
      <div class="w-full md:w-2/5 mx-auto pb-20 pt-0 md:pt-20">
        <div class="mx-auto w-screen-120 relative md:w-screen-70" style="right:60%; opacity: 0.9;">
          @svg('wireframe-caty')
        </div>
      </div>
      <div class="w-full md:w-3/5 md:pl-12 md:pl-32 pb-12 pt-0 md:pt-12 mx-auto">
        <h1 class="mb-2">Create Problem Solving</h1>
        <h2 class="mb-4">She's a good worker.</h2>
    ...
    <header class="flex flex-grow md:flex-row-reverse flex-wrap w-full overflow-hidden 
      ...
      <div class="w-full max-w-lg md:w-2/5 md:pl-12 mx-auto">
        <h1 class="mb-2">We know how to frame an issue</h1>
          <h2 class="mb-4">And do it </h2>
      </div>
    </header>
  @endwhile
@endsection
